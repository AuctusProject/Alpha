...
class Whitelist {
    ...
    request(cb) {
        ...
        web3Helper.sendTransaction(3, 70000, config.get('WHITELIST_OWNER'), config.get('WHITELIST_CONTRACT'), 0, data, config.get('WHITELIST_OWNER_KEY'), config.get('WHITELIST_CHAIN_ID'), cb);
